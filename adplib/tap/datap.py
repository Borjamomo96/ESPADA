...
class datap(dict): 
            ...
            for file in pb_files:
                ...
                if file.suffix == ".gz":
                    ...
                    if extracted_file_path.exists():
                        ...
                        if self.download_par['remove_compress_file']:
                            file.unlink()
                        ...
                        try:
                            ...
                            if self.download_par['delete_compressed_file']:
                                file.unlink()
                                logger.info(f"Compressed file deleted: {file}")
    ...
    def get_downloaded_mask_path(self, download_dir, dl_link_list):
        ...
        `self.download_par['delete_compressed_file']` setting. The most recently modified mask 
